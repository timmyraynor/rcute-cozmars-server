...
def poweroff_screen():
    return Image.open(static('poweroff.png')).rotate(270, expand=True)

def reboot_screen():
    return Image.open(static('reboot.png')).rotate(270, expand=True)
...
def splash_screen():
    ...
    return Image.open(splash).rotate(270, expand=True)
